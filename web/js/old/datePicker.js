...
var monthArrayShort = new Array('Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Jui', 'Jui', 'Aoû', 'Sep', 'Oct', 'Nov', 'Dec');
var monthArrayMed = new Array('Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Juin', 'Jui', 'Aoû', 'Sept', 'Oct', 'Nov', 'Dec');
...
function drawDatePicker(targetDateField, x, y)
{
  ...
  refreshDatePicker(targetDateField.name, (now.getFullYear())-18, dt.getMonth(), dt.getDate());
}
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  html += "<button class='dpTodayButton' onClick='refreshDatePicker(\"" + dateFieldName + "\");'>ce jour</button> ";
