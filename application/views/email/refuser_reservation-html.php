...
<html class="no-js">
    ...
    <body>
        ...
        <div class="contenu">
            <p class="bonjour">Bonjour <?php echo isset($user_demande->username) ? $user_demande->username : $user_demande->email ?>,</p>
            <p>Votre demande de réservation de <?php echo $place ?> place(s) pour l'annonce suivante a été refusée.</p>
